    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(default=True)),
                ('type', models.CharField(choices=[('Gold 999', 'gold 999'), ('Gold 999 1kg', 'gold 999 1kg'), ('Gold 995', 'gold 995'), ('Gold 995 1kg', 'gold 995 1kg'), ('Silver', 'silver')], default='Gold 999', max_length=200)),
